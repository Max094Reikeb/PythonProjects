...
class Board:
    ...
    def render(self):
        ...
        print('')
        print('>> Commandes :')
        print('>> "new" pour une nouvelle partie')
        print('>> "e2e4" pour bouger une pièce (par exemple de e2 à e4 ici)')
        print('>> "e7e8q" pour bouger la reine ("r" pour le rook, "n" pour un chevalier, "b" pour le pion)')
        print('>> "legalmoves" montre les coups possibles pour le joueur en action')
        print('>> "undomove" pour annuler le dernier coup')
        print('>> "go" fait jouer IA')
        print('>> "setboard [fen]" pour mettre le plateau selon la notation FEN que vous avez')
        print('>> "getboard" pour exporter le plateau sous la notation FEN')
        print('>> "sd [x]" pour mettre IA à x noeux')
        print('>> "perft [x]" : pour tester le générateurs de x noeux')
        print('>> "quit" pour quiter')
        print('')         
        ...
        print('Couleur en jeu : '+self.side2move)
        
        if(self.ep!=-1):
            print('"en passant" possible en',self.coord[self.ep])
            
        # Displaying castle rights
        no_castle_right=True
        print('Identifiants du Chateau : ',end='')
        if(self.white_can_castle_63):
            print('K',end='')
            no_castle_right=False
        if(self.white_can_castle_56):

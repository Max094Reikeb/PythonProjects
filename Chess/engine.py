...
class Engine:
    ...
    def usermove(self,b,c):
        ...
        (b.domove(pos1,pos2,promote)==False)):
            print("\n"+c+' : mouvement incorrect ou roi en échec'+"\n")
            return
    ...
    def chkCmd(self,c):
        ...
        err=(
        'Le mouvement doit être indiqué par 4 ou 5 lettres : e2e4, b1c3, e7e8q...',
        'Indication du mouvement incorrecte.'
        )        
    ...
    def search(self,b):
        ...
        print("Niveau\tNoeux\tScore\tMouvements")
    ...
    def setDepth(self,c):
        ...
        try:
            ...
            print('Le niveau entré n\'est pas un nombre. Entrez i.e. : sd 5')
            return
            
        if(d<2 or d>self.MAX_PLY):
            print('Le niveau doit être entre 2 et',self.MAX_PLY)
            return
        
        # Things seems to be all right
        self.init_depth=d
        print('Le niveau a été mis à',d)
    ...
    def perft(self,c,b):
        ...
        print("Niveau\tNoeux\tKills\tE.p.\tChateaux\tPromotions\tEchecs\tMats")
    ...
    def legalmoves(self,b):
        ...
        for m in mList:
            if(not b.domove(m[0],m[1],m[2])):
                continue            
            print('mouvement #',cpt,':',b.caseInt2Str(m[0])+b.caseInt2Str(m[1])+m[2])
            b.undomove()
            cpt+=1
    ...
    def bench(self,b):
        ...
        for i in range(3):
            ...
            print('Recherche pour le niveau',self.init_depth,'...')
